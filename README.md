...
В качестве альтернативного подхода может быть разработан **superbuild** [CMake-скрипт](CMake_GoogleTest.md), который самостоятельно загружает Google Test и собирает его. Под термином **superbuild** подразумевается набор из файлов CMakeLists.txt, задачей которого является, в том числе, загрузка необходимых компонентов из интернет, если они не установлены в целевой системе. Можно назвать **superbuild** шаблоном организации системы сборки, решающим задачи:
